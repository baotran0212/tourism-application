...
public class DatePicker {
	...
	public DatePicker(JComponent parent) {
		...
		for (int x = 0; x < button.length; x++) {
			...
			button[x] = new JButton();
			button[x].setFocusPainted(false);
			/*TODO: Set backgound button[x]
				Set foreground button[x]
				Set border button[x]
			*/
			if (x > 6)
				button[x].addActionListener(new ActionListener() {
		...
		JPanel p2 = new JPanel(new GridLayout(1, 3));
		//TODO: Set Background p2
		JButton previous = new JButton("<< Previous");
		/*TODO: Set Foreground previous
		 * Set Background previous
		 * Set Border previous
		 */
		previous.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
		...
		p2.add(previous);
		//TODO: Set foreground l
		p2.add(l);
		JButton next = new JButton("Next >>");
		/*TODO: Set Foregound next
			Set Backgound next
			Set Border next
		*/
		next.addActionListener(new ActionListener() {
